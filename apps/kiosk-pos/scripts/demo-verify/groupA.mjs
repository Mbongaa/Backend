...
const SCREENS = [
  ...
  { id: "A2", label: "AI Insights", name: "AI Insights (live aggregate sources)",
  ...
  { id: "A5", label: "Items Catalog", name: "Items Catalog",
  ...
  { id: "A7", label: "Daily Close", name: "Daily Close",
    live: [/Erbil Mall/, /Mansour District/, /Karrada/, /-40K/, /Needs review|review/i], nums: [] },
